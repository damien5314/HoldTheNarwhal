...
public class SettingsManager {
    ...
    public void saveSettings(UserSettings settings) {
        mContext.getSharedPreferences(PREFS_USER, Context.MODE_PRIVATE).edit()
                ...
                .putString(PREF_MIN_COMMENT_SCORE, String.valueOf(settings.getMinCommentScore()).equals("null") ? "" : String.valueOf(settings.getMinCommentScore()))
                .putString(PREF_MIN_LINK_SCORE, String.valueOf(settings.getMinLinkScore()).equals("null") ? "" : String.valueOf(settings.getMinLinkScore()))
